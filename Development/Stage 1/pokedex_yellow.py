...
window.config(padx=5, pady=15, background="yellow", relief=RAISED, bd=35)
...
# Title
title_label = Label(window, text="Desktop Pokédex", font=("Arial Bold", 15), bg="yellow", fg="black",
...
# Pokemon ID / Name
p_name = Label(window, text="Pokémon ID/Name:", font=("Arial Bold", 10), bg="yellow", fg="black",
               relief=RAISED, bd=10, padx=10, pady=1, width=14, anchor="center")
p_name.place(x=150, y=140)
# Pokemon ID / Name Response
pokemon_information = Label(window, font=("Arial Bold", 10), bg="yellow", fg="black",
                            relief=RAISED, bd=10, padx=10, pady=1, width=14, anchor="center")
pokemon_information.place(x=150, y=180)
# Pokemon Type
p_name = Label(window, text="Pokémon Type:", font=("Arial Bold", 10), bg="yellow", fg="black",
               relief=RAISED, bd=10, padx=10, pady=1, width=14, anchor="center")
p_name.place(x=150, y=220)
# Pokemon Type Response
pokemon_types = Label(window, font=("Arial Bold", 10), bg="yellow", fg="black",
                      relief=RAISED, bd=10, padx=10, pady=1, width=14, anchor="center")
...
load_pokemon()
text_id_name.config(font=("Arial", 12), width=22, bg="yellow",
                    relief=SUNKEN, bd=10)
text_id_name.place(x=10, y=70)

# Button = when clicked, loads Pokémon
btn_load = Button(window, command=load_pokemon, text="Select", font=("Arial Bold", 10), bg="yellow", fg="black",
